...
import { CalendarRange, CheckCircle2, CreditCard, ShieldCheck, Sparkles, UsersRound } from 'lucide-react';
...
export function PublicSubscriptionView() {
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#f8fbff_0%,#eef6ff_45%,#ffffff_100%)] px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-4 text-3xl font-semibold tracking-[-0.02em] text-slate-950 sm:text-4xl">
        ...
        <Card className="mx-auto w-full max-w-3xl overflow-hidden border-sky-100 bg-white shadow-[0_24px_80px_rgba(14,165,233,0.10)]">
          ...
          <CardHeader className="space-y-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5 text-left sm:min-w-[220px]">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Button asChild size="lg" variant="outline" className="flex-1 rounded-xl border-sky-200 text-sky-700 hover:bg-sky-50">
                <Link href="/autenticacao">Já tenho conta</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
