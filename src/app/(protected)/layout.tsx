...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SidebarProvider>
      <div className="relative min-h-screen overflow-hidden bg-[linear-gradient(135deg,#eef5ff_0%,#e0efff_36%,#d8ebff_68%,#d3e7ff_100%)]">
        ...
        <div className="relative flex min-h-screen w-full">
          ...
          <main className="flex min-h-screen min-w-0 flex-1 p-2 md:p-3 lg:p-4">
            <div className="relative flex min-h-[calc(100vh-1rem)] w-full min-w-0 flex-col overflow-hidden rounded-[30px] border border-white/80 bg-white/74 shadow-[0_20px_50px_rgba(125,160,220,0.14)] backdrop-blur-xl md:min-h-[calc(100vh-1.5rem)]">
