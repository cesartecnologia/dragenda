  ...
  return (
    <div className="mx-auto mb-2 max-w-5xl px-6 pt-1">
      <div className="flex items-center justify-center">
        <div className="flex flex-col items-center justify-center gap-1.5 text-center sm:flex-row sm:items-center sm:gap-3">
          {clinic.logoUrl ? (
            <div className="relative h-[46px] w-20 shrink-0 overflow-hidden bg-transparent">
          ...
          <div className="space-y-0">
            ...
            <div className="text-[0.82rem] font-normal leading-tight text-slate-500 md:text-[0.86rem]">
              ...
              {clinic.address ? <div className="text-slate-500/90">{clinic.address}</div> : null}
            </div>
          </div>
        </div>
      </div>
